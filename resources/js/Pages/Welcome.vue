        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:gap-36">
          <div
            ...
            <div class="flex flex-col justify-between w-full gap-4">
              ...
              <div class="flex flex-row flex-wrap justify-between w-full gap-4 mt-4">
                <div>
                  <PrimaryButton v-bind:class="loading
          ...
          <div
            class="flex p-6 transition-all scale-100 rounded-lg shadow-2xl h-fit bg-gray-800/50 bg-gradient-to-bl backdrop-blur-sm from-gray-700/50 via-transparent ring-1 ring-inset ring-white/5 shadow-gray-500/20 dark:shadow-none duration-250 focus:outline focus:outline-2 focus:outline-red-500">
            <div class="flex flex-col justify-between w-full gap-4">
              <div>
                ...
                <template v-if="loading">
                  ...
                  <div class="flex flex-col items-center justify-center text-white">
                    <svg class="transition-all duration-200 h-44 animate-spin" viewBox="0 0 800 800"
                      xmlns="http://www.w3.org/2000/svg">
                      <circle opacity="0.25" cx="400" cy="400" fill="none" r="200" stroke-width="15" stroke="#dc2626"
                ...
                <template v-else>
                  <div class="flex flex-col justify-between">
                    <div>
                      <h4 v v-if="randomUser.name" class="mt-4 leading-relaxed text-gray-200">
                        {{ randomUser.name }}
                      </h4>
